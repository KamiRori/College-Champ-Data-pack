...
execute if score modifier_teamrelay ar_game matches 1 if score @s ar_secdif_sgn matches -1 run tellraw @s ["第",{"score":{"name": "@s","objective": "ar_laps"},"color": "aqua"},"§b","圈 ","区域§b4/9", "䅀 ",{"score":{"name": "@s","objective": "ar_secdif_m"},"color": "green"},"§a:",{"score":{"name": "@s","objective": "ar_zeropad_s"},"color": "green"},{"score":{"name": "@s","objective": "ar_secdif_s"},"color": "green"},"§a.",{"score":{"name": "@s","objective": "ar_zeropad_ms"},"color": "green"},{"score":{"name": "@s","objective": "ar_secdif_ms"},"color": "green"}]
execute if score modifier_teamrelay ar_game matches 1 if score @s ar_secdif_sgn matches 1 run tellraw @s ["第",{"score":{"name": "@s","objective": "ar_laps"},"color": "aqua"},"§b","圈 ","区域§b4/9", "䅁 ",{"score":{"name": "@s","objective": "ar_secdif_m"},"color": "red"},"§c:",{"score":{"name": "@s","objective": "ar_zeropad_s"},"color": "red"},{"score":{"name": "@s","objective": "ar_secdif_s"},"color": "red"},"§c.",{"score":{"name": "@s","objective": "ar_zeropad_ms"},"color": "red"},{"score":{"name": "@s","objective": "ar_secdif_ms"},"color": "red"}]
