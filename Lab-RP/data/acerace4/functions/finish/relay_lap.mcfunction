...
scoreboard objectives add ar_lapsOverride dummy
execute if entity @s[team=red] run scoreboard players operation @s ar_lapsOverride = red ar_teamrelay_laps
execute if entity @s[team=blue] run scoreboard players operation @s ar_lapsOverride = blue ar_teamrelay_laps
execute if entity @s[team=green] run scoreboard players operation @s ar_lapsOverride = green ar_teamrelay_laps
execute if entity @s[team=yellow] run scoreboard players operation @s ar_lapsOverride = yellow ar_teamrelay_laps
execute if entity @s[team=cyan] run scoreboard players operation @s ar_lapsOverride = cyan ar_teamrelay_laps
execute if entity @s[team=pink] run scoreboard players operation @s ar_lapsOverride = pink ar_teamrelay_laps
execute if entity @s[team=orange] run scoreboard players operation @s ar_lapsOverride = orange ar_teamrelay_laps
execute if entity @s[team=purple] run scoreboard players operation @s ar_lapsOverride = purple ar_teamrelay_laps

# Lap time saved (Only first 3 laps)
...
title @s title ["§a第",{"score":{"name": "@s","objective": "ar_lapsOverride"},"color": "green"},"§a/",{"score":{"name": "totalLaps","objective": "ar_teamrelay_laps"},"color": "green"},"§a圈"]
...
scoreboard objectives remove ar_lapsOverride
