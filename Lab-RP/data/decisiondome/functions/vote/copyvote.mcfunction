...
execute unless score 1 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["1","ddvotecount"]}
execute unless score 2 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["2","ddvotecount"]}
execute unless score 3 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["3","ddvotecount"]}
execute unless score 4 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["4","ddvotecount"]}
execute unless score 5 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["5","ddvotecount"]}
execute unless score 6 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["6","ddvotecount"]}
execute unless score 7 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["7","ddvotecount"]}
execute unless score 8 tourney_games matches 0 run summon area_effect_cloud 11000 50 11000 {Duration:99999,Tags:["8","ddvotecount"]}
