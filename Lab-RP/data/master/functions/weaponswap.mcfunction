...
# Modifier: Team Fight
#execute if score modifier_teamfight sba_game matches 1 run function skybattle:modifiers/teamfight
# Init Game after modifier
function weaponswap:initgame
...
scoreboard players set 20 dd_games 1
