...
# target
execute as @a[team=!spec,gamemode=!spectator,tag=!temp_user,distance=0..5] run tag @s add temp_target

execute as @a[tag=temp_target] run scoreboard players set @s temp_toolstats 1
