...
execute if score gamecount tourney_stats matches 1 run schedule function fatesplate:multiboard/1_5 70t
execute if score gamecount tourney_stats matches 3 run schedule function fatesplate:multiboard/2_0 70t
execute if score gamecount tourney_stats matches 5 run schedule function fatesplate:multiboard/2_5 70t
execute if score gamecount tourney_stats matches 7 run schedule function fatesplate:multiboard/3_0 70t
...
execute if score modifiers_chaos_multi tourney_stats matches 1 run function fatesplate:elevatorjoke/chaos/multi_override
