...
execute if score map ws_game matches 1 run summon area_effect_cloud 36000 100 36000 {Duration:999999,Tags:[weaponswap,bordercenter]}

# Init Width
scoreboard players set widthmove ws_game 0
kill @e[type=area_effect_cloud,tag=borderwidth]
schedule function weaponswap:border/widthinit 10t
schedule function weaponswap:border/widthinitmove 10t
