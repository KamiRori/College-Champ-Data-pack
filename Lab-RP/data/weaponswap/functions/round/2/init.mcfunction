...
execute if score map ws_game matches 1 run tp @a 36000 120 36000

# Round no.
scoreboard players set widthcd ws_game 0
scoreboard players set heightcd ws_game 2
scoreboard players set round ws_game 2
...
forceload add 36000 36000
function weaponswap:border/init2
# Teleport Players
...
# Round Modifier
execute if score map ws_game matches 1 run schedule function weaponswap:round_modifier/map1/2 4s