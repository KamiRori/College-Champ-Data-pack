...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 4-0_lose tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "4-0_lose","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§c[§r鄵§c] ",{"text": "你的队伍已全部陷入红温，回合失败！","color": "red","bold": true}]
