...
$title @a[team=$(team)] title [{"text": "大获全胜！","color": "green","bold": true}]
...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 4-0_win tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "4-0_win","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§a[§r彀§a] ",{"text": "你的队伍已将全部对手打入红温，提前获胜！","color": "green","bold": true}]
