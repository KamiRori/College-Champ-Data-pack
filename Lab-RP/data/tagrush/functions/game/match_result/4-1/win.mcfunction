...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 4-1_win tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "4-1_win","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§a[§r彀§a] ",{"text": "你的队伍存活玩家更多，回合获胜！ (4-1)","color": "green","bold": true}]
