...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 3-3 tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "3-3","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§c[§r鄵§c] ",{"text": "平局！再接再厉！ (3-3)","color": "yellow","bold": true}]
