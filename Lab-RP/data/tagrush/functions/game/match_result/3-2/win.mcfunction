...
$title @a[team=$(team)] title [{"text": "险胜！","color": "green","bold": true}]
...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 3-2_win tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "3-2_win","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§a[§r彀§a] ",{"text": "你的队伍存活玩家更多，回合获胜！ (3-2)","color": "green","bold": true}]
