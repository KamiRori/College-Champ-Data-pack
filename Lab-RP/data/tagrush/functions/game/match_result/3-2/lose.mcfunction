...
$title @a[team=$(team)] title [{"text": "惜败！","color": "red","bold": true}]
...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 3-2_lose tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "3-2_lose","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§c[§r鄵§c] ",{"text": "对手存活玩家更多，回合失败！ (2-3)","color": "red","bold": true}]
