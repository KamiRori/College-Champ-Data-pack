...
$scoreboard players operation @a[team=$(team)] tagrush_indvscore += 4-2_lose tagrush_stats 
$tellraw @a[team=$(team)] ["[§6+",{"score":{"name": "4-2_lose","objective": "tagrush_stats"},"color": "gold"},"§6分§r] ","§c[§r鄵§c] ",{"text": "对手存活玩家更多，回合失败！ (2-4)","color": "red","bold": true}]
