...
# Player Specific
###
execute if entity @s[scores={univ_pid=31}] run tellraw @p[advancements={utils:killed/31=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=31}] run execute as @p[advancements={utils:killed/31=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=31}] run execute as @p[advancements={utils:killed/31=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=31}] run execute as @p[advancements={utils:killed/31=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=32}] run tellraw @p[advancements={utils:killed/32=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=32}] run execute as @p[advancements={utils:killed/32=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=32}] run execute as @p[advancements={utils:killed/32=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=32}] run execute as @p[advancements={utils:killed/32=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=33}] run tellraw @p[advancements={utils:killed/33=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=33}] run execute as @p[advancements={utils:killed/33=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=33}] run execute as @p[advancements={utils:killed/33=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=33}] run execute as @p[advancements={utils:killed/33=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=34}] run tellraw @p[advancements={utils:killed/34=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=34}] run execute as @p[advancements={utils:killed/34=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=34}] run execute as @p[advancements={utils:killed/34=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=34}] run execute as @p[advancements={utils:killed/34=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=35}] run tellraw @p[advancements={utils:killed/35=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=35}] run execute as @p[advancements={utils:killed/35=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=35}] run execute as @p[advancements={utils:killed/35=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=35}] run execute as @p[advancements={utils:killed/35=true}] run scoreboard players add @s tagrush_roundkills 1
