...
# Player Specific
###
execute if entity @s[scores={univ_pid=6}] run tellraw @p[advancements={utils:killed/6=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=6}] run execute as @p[advancements={utils:killed/6=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=6}] run execute as @p[advancements={utils:killed/6=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=6}] run execute as @p[advancements={utils:killed/6=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=7}] run tellraw @p[advancements={utils:killed/7=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=7}] run execute as @p[advancements={utils:killed/7=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=7}] run execute as @p[advancements={utils:killed/7=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=7}] run execute as @p[advancements={utils:killed/7=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=8}] run tellraw @p[advancements={utils:killed/8=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=8}] run execute as @p[advancements={utils:killed/8=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=8}] run execute as @p[advancements={utils:killed/8=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=8}] run execute as @p[advancements={utils:killed/8=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=9}] run tellraw @p[advancements={utils:killed/9=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=9}] run execute as @p[advancements={utils:killed/9=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=9}] run execute as @p[advancements={utils:killed/9=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=9}] run execute as @p[advancements={utils:killed/9=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=10}] run tellraw @p[advancements={utils:killed/10=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=10}] run execute as @p[advancements={utils:killed/10=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=10}] run execute as @p[advancements={utils:killed/10=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=10}] run execute as @p[advancements={utils:killed/10=true}] run scoreboard players add @s tagrush_roundkills 1
