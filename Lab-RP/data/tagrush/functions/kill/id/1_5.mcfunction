...
# Player Specific
###
execute if entity @s[scores={univ_pid=1}] run tellraw @p[advancements={utils:killed/1=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=1}] run execute as @p[advancements={utils:killed/1=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=1}] run execute as @p[advancements={utils:killed/1=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=1}] run execute as @p[advancements={utils:killed/1=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=2}] run tellraw @p[advancements={utils:killed/2=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=2}] run execute as @p[advancements={utils:killed/2=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=2}] run execute as @p[advancements={utils:killed/2=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=2}] run execute as @p[advancements={utils:killed/2=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=3}] run tellraw @p[advancements={utils:killed/3=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=3}] run execute as @p[advancements={utils:killed/3=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=3}] run execute as @p[advancements={utils:killed/3=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=3}] run execute as @p[advancements={utils:killed/3=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=4}] run tellraw @p[advancements={utils:killed/4=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=4}] run execute as @p[advancements={utils:killed/4=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=4}] run execute as @p[advancements={utils:killed/4=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=4}] run execute as @p[advancements={utils:killed/4=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=5}] run tellraw @p[advancements={utils:killed/5=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=5}] run execute as @p[advancements={utils:killed/5=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=5}] run execute as @p[advancements={utils:killed/5=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=5}] run execute as @p[advancements={utils:killed/5=true}] run scoreboard players add @s tagrush_roundkills 1
