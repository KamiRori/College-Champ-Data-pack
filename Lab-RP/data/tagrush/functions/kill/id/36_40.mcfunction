...
# Player Specific
###
execute if entity @s[scores={univ_pid=36}] run tellraw @p[advancements={utils:killed/36=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=36}] run execute as @p[advancements={utils:killed/36=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=36}] run execute as @p[advancements={utils:killed/36=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=36}] run execute as @p[advancements={utils:killed/36=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=37}] run tellraw @p[advancements={utils:killed/37=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=37}] run execute as @p[advancements={utils:killed/37=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=37}] run execute as @p[advancements={utils:killed/37=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=37}] run execute as @p[advancements={utils:killed/37=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=38}] run tellraw @p[advancements={utils:killed/38=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=38}] run execute as @p[advancements={utils:killed/38=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=38}] run execute as @p[advancements={utils:killed/38=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=38}] run execute as @p[advancements={utils:killed/38=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=39}] run tellraw @p[advancements={utils:killed/39=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=39}] run execute as @p[advancements={utils:killed/39=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=39}] run execute as @p[advancements={utils:killed/39=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=39}] run execute as @p[advancements={utils:killed/39=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=40}] run tellraw @p[advancements={utils:killed/40=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=40}] run execute as @p[advancements={utils:killed/40=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=40}] run execute as @p[advancements={utils:killed/40=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=40}] run execute as @p[advancements={utils:killed/40=true}] run scoreboard players add @s tagrush_roundkills 1
