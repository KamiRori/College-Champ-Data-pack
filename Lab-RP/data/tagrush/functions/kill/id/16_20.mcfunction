...
# Player Specific
###
execute if entity @s[scores={univ_pid=16}] run tellraw @p[advancements={utils:killed/16=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=16}] run execute as @p[advancements={utils:killed/16=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=16}] run execute as @p[advancements={utils:killed/16=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=16}] run execute as @p[advancements={utils:killed/16=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=17}] run tellraw @p[advancements={utils:killed/17=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=17}] run execute as @p[advancements={utils:killed/17=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=17}] run execute as @p[advancements={utils:killed/17=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=17}] run execute as @p[advancements={utils:killed/17=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=18}] run tellraw @p[advancements={utils:killed/18=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=18}] run execute as @p[advancements={utils:killed/18=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=18}] run execute as @p[advancements={utils:killed/18=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=18}] run execute as @p[advancements={utils:killed/18=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=19}] run tellraw @p[advancements={utils:killed/19=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=19}] run execute as @p[advancements={utils:killed/19=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=19}] run execute as @p[advancements={utils:killed/19=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=19}] run execute as @p[advancements={utils:killed/19=true}] run scoreboard players add @s tagrush_roundkills 1
...
###
###
execute if entity @s[scores={univ_pid=20}] run tellraw @p[advancements={utils:killed/20=true}] ["",{"text": "[§6+"},{"score":{"name": "Kill","objective": "tagrush_stats"},"color": "gold"},{"text":"分","color": "gold"},"] ",{"text":"你击杀了"},{"selector":"@s"},"!"]
execute if entity @s[scores={univ_pid=20}] run execute as @p[advancements={utils:killed/20=true}] run scoreboard players operation @s tagrush_indvscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=20}] run execute as @p[advancements={utils:killed/20=true}] run scoreboard players operation @s tagrush_roundscore += Kill tagrush_stats
execute if entity @s[scores={univ_pid=20}] run execute as @p[advancements={utils:killed/20=true}] run scoreboard players add @s tagrush_roundkills 1
