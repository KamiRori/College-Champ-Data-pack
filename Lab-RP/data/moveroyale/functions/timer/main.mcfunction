...
# No one in Round, ends the round early
execute unless score devMode moveroyale_game matches 1 unless entity @a[tag=moveroyale_inround] run scoreboard players set timeleft_t moveroyale_game 0

# Time runs out.
execute if score timeleft_t moveroyale_game matches ..0 if score gameflag moveroyale_game matches 1 run function moveroyale:round_end
# LOOP
execute if score gameflag moveroyale_game matches 1 run schedule function moveroyale:timer/main 1t