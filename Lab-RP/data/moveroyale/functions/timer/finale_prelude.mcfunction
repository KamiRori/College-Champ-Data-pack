...
# Time runs out.
execute if score timeleft_t moveroyale_game matches ..0 run function moveroyale:finale/select_start
execute if score timeleft_t moveroyale_game matches ..0 run return 0
# LOOP
execute if score phase_finale_prelude moveroyale_game matches 1 run schedule function moveroyale:timer/finale_prelude 1t