...
function moveroyale:challenge_set/iceboat/select_arena

# Time Limit Select
scoreboard players set timelimit_t moveroyale_game 1400
scoreboard players set timelimit_s moveroyale_game 70

# FX Queue
schedule function moveroyale:challenge_set/iceboat/prepare_fx/1 20t
