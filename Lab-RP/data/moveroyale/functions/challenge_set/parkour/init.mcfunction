...
scoreboard players set @a[scores={moveroyale_playing_copy=1..}] moveroyale_playing_copy 1

# Select the arena
scoreboard players set arena moveroyale_game 0
function moveroyale:challenge_set/parkour/select_arena

# Time Limit Select
scoreboard players set timelimit_t moveroyale_game 1300
scoreboard players set timelimit_s moveroyale_game 65

# FX Queue
schedule function moveroyale:challenge_set/parkour/prepare_fx/1 20t
...
# Pre round detect
function moveroyale:challenge_set/parkour/preround_detect
