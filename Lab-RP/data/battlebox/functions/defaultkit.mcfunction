...
# Wool
item replace entity @a[team=green] armor.feet with leather_boots{Unbreakable:1b,display:{color:6192150},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1
item replace entity @a[team=red] armor.feet with leather_boots{Unbreakable:1b,display:{color:11546150},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1
item replace entity @a[team=blue] armor.feet with leather_boots{Unbreakable:1b,display:{color:3949738},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1
item replace entity @a[team=yellow] armor.feet with leather_boots{Unbreakable:1b,display:{color:16701501},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1 
item replace entity @a[team=cyan] armor.feet with leather_boots{Unbreakable:1b,display:{color:30322},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1
item replace entity @a[team=orange] armor.feet with leather_boots{Unbreakable:1b,display:{color:16757504},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1
item replace entity @a[team=purple] armor.feet with leather_boots{Unbreakable:1b,display:{color:9437439},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1
item replace entity @a[team=pink] armor.feet with leather_boots{Unbreakable:1b,display:{color:16711927},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"minecraft:generic.armor",Amount:0,Operation:0,UUID:[I;1,2,3,4],Slot:"feet"}]} 1 
