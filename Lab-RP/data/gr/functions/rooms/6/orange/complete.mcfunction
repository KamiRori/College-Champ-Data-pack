...
# Remove creeper
kill @e[type=creeper,tag=orange,tag=gr_room]
...
# Announce position
tellraw @a[team=!orange] ["",{"translate":"team.orange"},"§7第",{"score":{"name": "6","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§2Creeper Guide","§e]"]
tellraw @a[team=orange] ["","§7你","§7第",{"score":{"name": "6","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§2Creeper Guide","§e]"]
# Initiate next room
