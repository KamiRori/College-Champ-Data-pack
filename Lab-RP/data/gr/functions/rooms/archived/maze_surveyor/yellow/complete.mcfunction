...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~2 105 ~14 ~2 105 ~16 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_yellowanchor] at @s run fill ~3 101 ~14 ~3 104 ~16 air
...
# Announce position
tellraw @a[team=!yellow] ["",{"translate":"team.yellow"},"§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§cMaze Surveyor","§e]"]
tellraw @a[team=yellow] ["","§7你","§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§cMaze Surveyor","§e]"]
# Initiate next room
