...
# Open Zone Gates
execute as @e[type=minecraft:area_effect_cloud,tag=gr_pinkanchor] at @s run fill ~8 86 ~5 ~28 86 ~23 air replace iron_bars
execute as @e[type=minecraft:area_effect_cloud,tag=gr_pinkanchor] at @s run fill ~7 86 ~17 ~7 89 ~13 air destroy
...
# Announce position
tellraw @a[team=!pink] ["",{"translate":"team.pink"},"§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§3Quartered Layers","§e]"]
tellraw @a[team=pink] ["","§7你","§7第",{"score":{"name": "8","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§3Quartered Layers","§e]"]
# Initiate next room
