...
# Modify scoreboard
scoreboard players display name var_room_name gr_redsb "§a§l当前房间: §cX-§rIce and Fire"
...
title @a[team=red] title "§e点亮末地传送门！"
# Give items
clear @a[team=red]
...
scoreboard players set @a[team=red] gr_xroom_craft_eeye 0
scoreboard players set @a[team=red] gr_xroom_use_epearl 0
scoreboard players set @a[team=red] gr_xroom_kill_blaze 0
