...
# Modify scoreboard
scoreboard players display name var_room_name gr_greensb "§a§l当前房间: §cX-§rIce and Fire"
...
title @a[team=green] title "§e点亮末地传送门！"
# Give items
clear @a[team=green]
...
scoreboard players set @a[team=green] gr_xroom_craft_eeye 0
scoreboard players set @a[team=green] gr_xroom_use_epearl 0
scoreboard players set @a[team=green] gr_xroom_kill_blaze 0
