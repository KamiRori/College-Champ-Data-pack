...
# 显示房间目标和当前用时
execute if score pink gr_currentsec matches 0..9 run title @a[team=pink] actionbar ["",{"score":{"name": "pink","objective": "gr_currentmin"}},":","0",{"score":{"name": "pink","objective": "gr_currentsec"}}," | ","[§e!§r]"," 点亮末地传送门。"]
execute if score pink gr_currentsec matches 10..59 run title @a[team=pink] actionbar ["",{"score":{"name": "pink","objective": "gr_currentmin"}},":","",{"score":{"name": "pink","objective": "gr_currentsec"}}," | ","[§e!§r]"," 点亮末地传送门。"]