...
# Modify scoreboard
scoreboard players display name var_room_name gr_bluesb "§a§l当前房间: §cX-§rIce and Fire"
...
title @a[team=blue] title "§e点亮末地传送门！"
# Give items
clear @a[team=blue]
...
scoreboard players set @a[team=blue] gr_xroom_craft_eeye 0
scoreboard players set @a[team=blue] gr_xroom_use_epearl 0
scoreboard players set @a[team=blue] gr_xroom_kill_blaze 0
