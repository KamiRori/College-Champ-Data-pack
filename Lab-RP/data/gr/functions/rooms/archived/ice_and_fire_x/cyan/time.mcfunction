...
# 显示房间目标和当前用时
execute if score cyan gr_currentsec matches 0..9 run title @a[team=cyan] actionbar ["",{"score":{"name": "cyan","objective": "gr_currentmin"}},":","0",{"score":{"name": "cyan","objective": "gr_currentsec"}}," | ","[§e!§r]"," 点亮末地传送门。"]
execute if score cyan gr_currentsec matches 10..59 run title @a[team=cyan] actionbar ["",{"score":{"name": "cyan","objective": "gr_currentmin"}},":","",{"score":{"name": "cyan","objective": "gr_currentsec"}}," | ","[§e!§r]"," 点亮末地传送门。"]