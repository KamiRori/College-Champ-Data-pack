...
# 显示房间目标和当前用时
execute if score red gr_currentsec matches 0..9 run title @a[team=red] actionbar ["",{"score":{"name": "red","objective": "gr_currentmin"}},":","0",{"score":{"name": "red","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]
execute if score red gr_currentsec matches 10..59 run title @a[team=red] actionbar ["",{"score":{"name": "red","objective": "gr_currentmin"}},":","",{"score":{"name": "red","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]