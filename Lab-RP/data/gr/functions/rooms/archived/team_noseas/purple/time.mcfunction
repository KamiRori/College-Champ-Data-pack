...
# 显示房间目标和当前用时
execute if score purple gr_currentsec matches 0..9 run title @a[team=purple] actionbar ["",{"score":{"name": "purple","objective": "gr_currentmin"}},":","0",{"score":{"name": "purple","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]
execute if score purple gr_currentsec matches 10..59 run title @a[team=purple] actionbar ["",{"score":{"name": "purple","objective": "gr_currentmin"}},":","",{"score":{"name": "purple","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]