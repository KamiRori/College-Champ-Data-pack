...
clear @a[team=cyan]
# Item
give @a[team=cyan] iron_hoe{CanDestroy:[kelp,horn_coral_fan,brain_coral,seagrass,sponge,wet_sponge],Unbreakable:1b}
give @a[team=cyan] iron_shovel{CanDestroy:[gravel],Unbreakable:1b}
give @a[team=cyan] gravel{CanPlaceOn:[sand,sandstone,andesite,gravel,stone,horn_coral_block,brain_coral_block,sea_lantern,stone_bricks,cracked_stone_bricks],HideFlags:24} 192
give @a[team=cyan] sponge{CanPlaceOn:[sand,sandstone,andesite,gravel,stone,horn_coral_block,brain_coral_block,sea_lantern,stone_bricks,cracked_stone_bricks],HideFlags:24} 32

item replace entity @a[team=cyan] armor.feet with leather_boots{Enchantments:[{id:"depth_strider",lvl:3}]}

# Modify scoreboard
scoreboard players display name var_room_name gr_cyansb "§a§l当前房间: §r§cTeam #NoSeas"
