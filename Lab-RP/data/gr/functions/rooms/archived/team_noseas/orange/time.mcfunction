...
# 显示房间目标和当前用时
execute if score orange gr_currentsec matches 0..9 run title @a[team=orange] actionbar ["",{"score":{"name": "orange","objective": "gr_currentmin"}},":","0",{"score":{"name": "orange","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]
execute if score orange gr_currentsec matches 10..59 run title @a[team=orange] actionbar ["",{"score":{"name": "orange","objective": "gr_currentmin"}},":","",{"score":{"name": "orange","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]