...
# 显示房间目标和当前用时
execute if score yellow gr_currentsec matches 0..9 run title @a[team=yellow] actionbar ["",{"score":{"name": "yellow","objective": "gr_currentmin"}},":","0",{"score":{"name": "yellow","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]
execute if score yellow gr_currentsec matches 10..59 run title @a[team=yellow] actionbar ["",{"score":{"name": "yellow","objective": "gr_currentmin"}},":","",{"score":{"name": "yellow","objective": "gr_currentsec"}}," | ","[§e!§r]"," 抽干整片水域。"]