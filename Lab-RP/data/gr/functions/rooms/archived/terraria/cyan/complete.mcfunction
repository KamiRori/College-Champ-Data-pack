...
execute as @e[type=minecraft:area_effect_cloud,tag=gr_cyananchor] at @s run fill ~4 101 ~2 ~4 104 ~4 air
execute as @e[type=minecraft:area_effect_cloud,tag=gr_cyananchor] at @s run fill ~4 101 ~26 ~4 104 ~28 air
...
# Announce position
tellraw @a[team=!cyan] ["",{"translate":"team.cyan"},"§7第",{"score":{"name": "7","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§2Terraria?","§e]"]
tellraw @a[team=cyan] ["","§7你","§7第",{"score":{"name": "7","objective": "gr_indvroom"},"color": "aqua"},"§7个完成了房间","§e[","§2Terraria?","§e]"]
# Initiate next room
