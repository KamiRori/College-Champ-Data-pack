...
# Doubles every team's score
tellraw @a ["§b[§r坕§b] ",{"text": "Cross GR","color": "#E3E3E3"},"§b: 各队分数加倍结算。"]
scoreboard players operation red gr_teamscore *= 2 math
scoreboard players operation blue gr_teamscore *= 2 math
scoreboard players operation green gr_teamscore *= 2 math
scoreboard players operation yellow gr_teamscore *= 2 math
scoreboard players operation cyan gr_teamscore *= 2 math
scoreboard players operation pink gr_teamscore *= 2 math
scoreboard players operation orange gr_teamscore *= 2 math
scoreboard players operation purple gr_teamscore *= 2 math
